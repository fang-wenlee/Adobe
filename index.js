...
$(".filter-collection_section-title p").removeAttr("style","text-align:left");
...
$(".spectrum-Banner--value:eq(0)").css("background-color", "#472cb2");
$(".spectrum-Banner-header:eq(0) p span").css("color", "#fff");
...
function menuClick(){
 ...
 $(document).on('click', '#filterlist-react-spectrum-5 span', { name: "All apps" }, addProductView);
 $(document).on('click', '#filterlist-react-spectrum-6 span', { name: "Photo" }, addProductView);
 $(document).on('click', '#filterlist-react-spectrum-7 span', { name: "Graphic Design" }, addProductView);
 $(document).on('click', '#filterlist-react-spectrum-8 span', { name: "Video" }, addProductView);
 $(document).on('click', '#filterlist-react-spectrum-9 span', { name: "Illustration" }, addProductView);
 $(document).on('click', '#filterlist-react-spectrum-10 span', { name: "UI and UX" }, addProductView);
 $(document).on('click', '#filterlist-react-spectrum-11 span', { name: "Acrobat and PDF" }, addProductView);
 $(document).on('click', '#filterlist-react-spectrum-12 span', { name: "3D and AR" }, addProductView);
 $(document).on('click', '#filterlist-react-spectrum-13 span', { name: "Social Media" }, addProductView);
 $(document).on('click', '#filterlist-react-spectrum-14 span', { name: "Recommended for you" }, addProductView);
} 
 ...
 $(event.data.id).addClass("is-selected");
  var item = event.data.name;
      ...
      case "Recommended for you":	
            ...
            // $(".spectrum-Banner--halfRound").css("right", "-16px")
             break;				  
       default: 
...
//$(".spectrum-Banner--halfRound").css({"margin-right":"-15px", "background-color": "rgb(84 146 38);"});
         ...
         "<div class='container'>",
             "<div class='root responsivegrid'>",
                          "<div class='position' style='float:right'>",
                              "<div id='id-3b5ad8db1414825dfb2a8bbb868bf2a2'",
                              "class='dexter-Position  mobile-place-relative mobile-place-left mobile-place-top mobile-padding-top-0",
                              " mobile-padding-right-0 mobile-padding-bottom-0 mobile-padding-left-0 mobile-margin-top-0 mobile-margin-right-0 mobile-margin-bottom-0 mobile-margin-left-0",
                              "dexter-Background dexter-LazyImage is-Editor-false data-animations='[]'>",
                              "<div class='aem-Grid aem-Grid--12 aem-Grid--default--12 '>",
                              "<div class='banner aem-GridColumn aem-GridColumn--default--12'>",
                              "<div data-analytics-banner='{}' class='spectrum-Banner spectrum-Banner--value spectrum-Banner--halfRound' style='margin-right: -15px; background-color: rgb(84 146 38);'>",
                              "<div class='spectrum-Banner-header'><p><span style='color:white'>Best Combo</span></p>",
